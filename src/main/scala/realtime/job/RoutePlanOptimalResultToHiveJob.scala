...
/**
 * @ClassName RoutePlanOptimalResultToHiveJob
 * @Description route_plan_result_optimal_queue 最优数据写入hive
 * @Author zhangleilei
 * @Date 2020/9/15 15:15
 * @Version 1.0
 */

object RoutePlanOptimalResultToHiveJob {
  ...
  def main(args: Array[String]): Unit = {
    ...
    properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "RoutePlanOptimalResultToHiveJob")
...
//    properties.put("flink.partition-discovery.interval-millis","10000")
    ...
    val flinkKafkaConsumer = new FlinkKafkaConsumer[String](ConfigUtils.kafkaTopicRoutePlanOptimalResult, new SimpleStringSchema(), properties)
...
//        println("record data ==============================" + record)
    ...
    tableEnv.createTemporaryView("tmp_route_plan_optimal_result", dataTable)


    val insertSql = """
                      |INSERT INTO t_route_plan_optimal_result
                      |select
                      |version as version,
                      ...
                      |from tmp_route_plan_optimal_result
                      |""".stripMargin
